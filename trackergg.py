        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get(url) as response:
                    ...
                    kd_element = soup.find('div', class_='trn-defstat__value')
                    rank_element = soup.find('div', class_='valorant-highlighted-stat__value')
                    peak_rank_element = soup.find('div', class_='valorant-highlighted-stat__value')
